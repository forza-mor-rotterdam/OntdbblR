...
def beheer(request):
    ...
    env_urls = [
        ...
        # (f"https://ontdbblr{env_suffixs.get(settings.APP_ENV, env_suffixs.get(settings.ACCEPTATIE))}.{domain}{beheer_url}", "OntdbblR"),
        (
            f"https://taakr{env_suffixs.get(settings.APP_ENV, env_suffixs.get(settings.ACCEPTATIE))}.{domain}{beheer_url}",
            "TaakR",
        ),
        (
            f"https://externr{env_suffixs.get(settings.APP_ENV, env_suffixs.get(settings.ACCEPTATIE))}.{domain}{beheer_url}",
            "ExternR",
        ),
    ]
