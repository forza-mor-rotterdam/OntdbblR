  ...
  sessionTimer() {
    ...
    var timer = setInterval(function () {
      ...
      console.log({
        ...
        countdown: sessionExpiryTimestamp - parseInt(parseInt(currentDate.getTime())),
      })
      console.log({
        sessionExpiryMaxTimestamp: sessionExpiryMaxTimestamp,
        countdownMax: sessionExpiryMaxTimestamp - parseInt(parseInt(currentDate.getTime())),
      })
